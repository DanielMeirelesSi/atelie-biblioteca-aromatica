...
export const products: Product[] = [
  ...
  {
    id: "arom-casa-chique",
    slug: "aromatizador-casa-chique",
    name: "Aromatizador de Varetas Casa Chique",
    category: "aromatizadores",
    type: "Aromatizador de varetas",
    fragrance: "Casa Chique",
    price: 35,
    weight: "250 ml",
    priceNote: "40 ml por R$ 15,00, 100 ml por R$ 25,00 e 250 ml por R$ 35,00.",
    shortDescription:
      "Aroma elegante e marcante, inspirado na sensação de entrar em uma loja sofisticada.",
    fullDescription:
      "Um dos aromas mais queridos do ateliê, o Casa Chique conquista pela elegância e sofisticação. Inspirado na sensação de entrar em uma loja sofisticada, é elegante, aconchegante e marcante. Devido à alta procura, é produzido somente sob encomenda, com prazo de 10 a 15 dias para produção e entrega. Disponível em 40 ml por R$ 15,00, 100 ml por R$ 25,00 e 250 ml por R$ 35,00.",
    image: "/produtos/aromatizador-casa-chique.jpeg",
    imageAlt: "Aromatizador de varetas Casa Chique em frascos de vidro",
    available: false,
  },
  {
    id: "vela-casa-chique",
    slug: "vela-casa-chique-150g",
    name: "Vela Aromática Casa Chique 150 g",
    ...
    weight: "150 g",
    shortDescription:
      "Uma das fragrâncias mais amadas do ateliê. Aroma elegante que deixa o ambiente sofisticado.",
    fullDescription:
      "A vela Casa Chique é uma das fragrâncias mais amadas do ateliê. Um aroma elegante, aconchegante e perfeito para deixar qualquer ambiente sofisticado. Produzida sob encomenda.",
    image: "/produtos/vela-casa-chique.jpeg",
    imageAlt: "Vela aromática Casa Chique em pote de vidro",
    available: false,
  },
  {
    id: "escalda-pes",
  ...
  },
  {
    ...
    price: 35,
    isKit: true,
    priceNote: "R$ 12,00 cada unidade.",
    shortDescription:
      "Três sabonetes cítricos e refrescantes: Verbena, Bamboo com Limão Siciliano e Limão Siciliano.",
    fullDescription:
      "Com 3 sabonetes artesanais de fragrâncias cítricas e refrescantes: Verbena, Bamboo com Limão Siciliano e Limão Siciliano. Ideal para quem ama uma sensação de limpeza, frescor e perfume duradouro. R$ 35,00 o kit ou R$ 12,00 cada unidade.",
    image: "/produtos/kit-citrico.jpeg",
    imageAlt: "Kit com três sabonetes artesanais de fragrâncias cítricas",
    available: true,
  },
  {
    id: "mini-vela-aromatica",
    slug: "mini-vela-aromatica-30min",
    name: "Mini Vela Aromática",
    category: "velas-aromaticas",
    type: "Vela aromática",
    fragrance: "Sortido",
    price: 6,
    shortDescription:
      "Perfumada e delicada, com cerca de 30 minutos de queima. Perfeita para um momento de relaxamento.",
    fullDescription:
      "Perfumada e delicada, com cerca de 30 minutos de queima, é perfeita para criar um momento de relaxamento. Seu aroma suave deixa o ambiente mais acolhedor, tornando cada pausa ainda mais especial.",
    image: "/produtos/mini-vela-aromatica.jpeg",
    imageAlt: "Mini velas aromáticas em formato de flor",
    available: true,
  },
  {
    id: "sab-limpeza-energetica",
    slug: "sabonete-limpeza-energetica",
    name: "Sabonete de Limpeza Energética",
    category: "sabonetes-artesanais",
    type: "Sabonete artesanal",
    fragrance: "Alecrim e Sal Grosso",
    price: 12,
    weight: "90 g",
    priceNote: "Versão mini mousse por R$ 6,00 e massageador com bucha por R$ 22,00.",
    shortDescription:
      "Com alecrim e sal grosso. Sensação de frescor, renovação e bem-estar para um banho de autocuidado.",
    fullDescription:
      "Com sal grosso e alecrim, promove uma sensação de renovação e bem-estar. O sal grosso ajuda a proporcionar uma sensação de leveza, enquanto o alecrim é conhecido pelo seu aroma revigorante e pela sensação de frescor que transmite. As folhas desidratadas de alecrim completam a experiência com um toque natural e artesanal. Ideal para transformar o banho em um momento de autocuidado, leveza e boas energias. Disponível nas versões mini mousse por R$ 6,00, 90 g por R$ 12,00 e massageador com bucha por R$ 22,00.",
    image: "/produtos/sabonete-limpeza-energetica.jpeg",
    imageAlt: "Sabonete artesanal verde de limpeza energética com alecrim",
    available: true,
  },
  {
    id: "kit-poema-lavanda",
    slug: "kit-poema-de-lavanda",
    name: "Kit Poema de Lavanda",
    category: "kits",
    type: "Kit de presente",
    fragrance: "Lavanda",
    price: 64.9,
    isKit: true,
    shortDescription:
      "Kit artesanal de lavanda com sabonetes, vela de massagem, aromatizador, cheirinho de lençóis e mimo.",
    fullDescription:
      "Um kit artesanal perfeito para presentear ou transformar seus momentos de autocuidado. Contém 2 sabonetes artesanais, 1 vela de massagem, 1 aromatizador de varetas, 1 cheirinho para lençóis e 1 mimo com corações perfumados de cera de coco.",
    image: "/produtos/kit-poema-de-lavanda.jpeg",
    imageAlt: "Kit Poema de Lavanda em caixa de madeira",
    available: true,
  },
  {
    id: "spray-lencol-melancia",
    slug: "cheirinho-lencois-melancia",
    name: "Cheirinho para Lençóis de Melancia",
    category: "sprays",
    ...
    weight: "50 ml",
    shortDescription:
      "Perfuma lençóis e tecidos com o aroma refrescante de melancia. Ideal para roupas de cama e sofás.",
    fullDescription:
      "Deixe seus lençóis e tecidos delicadamente perfumados com o aroma refrescante e aconchegante de melancia. Ideal para roupas de cama, cortinas, almofadas e sofás.",
    image: "/produtos/cheirinho-lencois-melancia.jpeg",
    imageAlt: "Cheirinho para lençóis com fragrância de melancia",
    available: true,
  },
  {
    id: "spray-lencol-maracuja",
    slug: "cheirinho-lencois-maracuja",
    name: "Cheirinho para Lençóis de Maracujá",
    category: "sprays",
    type: "Spray aromatizante",
    fragrance: "Maracujá",
    price: 15,
    weight: "50 ml",
    shortDescription:
      "Perfuma lençóis e tecidos com o aroma de maracujá. Ideal para roupas de cama, cortinas e sofás.",
    fullDescription:
      "Deixe seus lençóis e tecidos delicadamente perfumados com o aroma refrescante e aconchegante de maracujá. Ideal para roupas de cama, cortinas, almofadas e sofás.",
    image: "/produtos/cheirinho-lencois-maracuja.jpeg",
    imageAlt: "Cheirinho para lençóis com fragrância de maracujá",
    available: true,
  },
  {
    id: "sab-pausa-cafe",
    slug: "sabonete-pausa-pro-cafe",
    name: "Sabonete Pausa pro Café",
    category: "sabonetes-artesanais",
    type: "Sabonete artesanal",
    fragrance: "Café",
    price: 12,
    ...
    shortDescription:
      "Com pó de café, esfolia naturalmente e ajuda a neutralizar odores nas mãos após cozinhar.",
    fullDescription:
      "Feito com pó de café, um esfoliante natural que ajuda a remover as células mortas, deixando a pele macia e renovada. Além disso, é excelente para ajudar a remover das mãos odores persistentes, como alho, cebola e outros temperos após cozinhar. Seu aroma aconchegante transforma o banho em um momento de autocuidado e revitalização. Disponível na versão mini mousse por R$ 6,00 e 90 g por R$ 12,00.",
    image: "/produtos/sabonete-pausa-pro-cafe.jpeg",
    imageAlt: "Sabonetes artesanais de café em formato mousse e redondo",
    available: true,
  },
  /*{
